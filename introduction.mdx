    ...
    <table className="performance-table">
      ...
      <tbody>
        ...
        <tr className="rank-2">
          ...
          <td className="model-type-cell" data-label="Model Type">Proprietary</td>
          <td className="date-cell" data-label="Date">2025-08-07</td>
          <td className="score-cell" data-label="Pass@1">30.6<sub>± 1.5</sub></td>
          ...
          <td className="score-cell" data-label="Avg Cost">$40</td>
        </tr>
        ...
        <tr className="rank-other">
          ...
          <td className="model-type-cell" data-label="Model Type">Open-Source</td>
          <td className="date-cell" data-label="Date">2025-09-05</td>
          ...
          <td className="score-cell" data-label="Avg Cost">$22</td>
        </tr>
        <tr className="rank-other">
          ...
          <td className="model-type-cell" data-label="Model Type">Proprietary</td>
          <td className="date-cell" data-label="Date">2025-06-17</td>
          ...
          <td className="score-cell" data-label="Avg Cost">$41</td>
        </tr>
      </tbody>
    </table>
  </div>
