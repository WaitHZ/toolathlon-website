---
title: "How to use Toolathlon"
---


## Quick Start
> Basically you have four ways of running Toolathlon evaluation:
> 1. Using our public evaluation service: Check [EVAL_SERVICE_README.md](https://github.com/hkust-nlp/Toolathlon/blob/main/EVAL_SERVICE_README.md) for more details.
...
Please make sure to check [EVAL_SERVICE_README.md](https://github.com/hkust-nlp/Toolathlon/blob/main/EVAL_SERVICE_README.md) for more details (e.g. if you want to test your locally deployed models).
...
If you are unable/unwilling to install docker/podman, but still want to try our benchmark, please refer to [README_nodocker.md](https://github.com/hkust-nlp/Toolathlon/blob/main/README_nodocker.md).
...
Please read carefully through [how2register_accounts.md](https://github.com/hkust-nlp/Toolathlon/blob/main/global_preparation/how2register_accounts.md) and follow the guides. You need to register some accounts and configure some tokens/api keys/secrets in `configs/token_key_session.py`. 
