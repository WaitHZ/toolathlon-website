...
<div className="stats-container">
  ...
  <div className="stat-card">
    <div className="stat-number">76.23%</div>
    ...
    <table className="performance-table">
      ...
      <tbody>
        <tr className="rank-1">
          ...
          <td className="score-cell best-score" data-label="Pass@1">76.23<sub>± 3.41</sub></td>
          <td className="score-cell best-score" data-label="Pass@3">84.26</td>
          <td className="score-cell best-score" data-label="Pass^3">66.67</td>
          <td className="score-cell" data-label="Avg. Turns">19.92</td>
        </tr>
        <tr className="rank-2">
          ...
          <td className="text-cell" data-label="Agent">Default</td>
          <td className="date-cell" data-label="Date">2026-06-30</td>
          <td className="score-cell" data-label="Pass@1">73.46<sub>± 1.15</sub></td>
          <td className="score-cell" data-label="Pass@3">82.41</td>
          <td className="score-cell" data-label="Pass^3">62.04</td>
          <td className="score-cell" data-label="Avg. Turns">24.44</td>
        </tr>
        <tr className="rank-3">
        ...
        <tr className="rank-other">
          ...
          <td className="text-cell" data-label="Agent">Default</td>
          <td className="date-cell" data-label="Date">2026-06-30</td>
          <td className="score-cell" data-label="Pass@1">58.02<sub>± 4.30</sub></td>
          <td className="score-cell" data-label="Pass@3">74.07</td>
          <td className="score-cell" data-label="Pass^3">41.67</td>
          <td className="score-cell" data-label="Avg. Turns">23.08</td>
        </tr>
        <tr className="rank-other">
          ...
          <td className="text-cell" data-label="Agent">Default</td>
          <td className="date-cell" data-label="Date">2026-06-30</td>
          <td className="score-cell" data-label="Pass@1">55.86<sub>± 1.15</sub></td>
          <td className="score-cell" data-label="Pass@3">68.52</td>
          <td className="score-cell" data-label="Pass^3">41.67</td>
          <td className="score-cell" data-label="Avg. Turns">23.56</td>
        </tr>
      </tbody>
    </table>
</div>
